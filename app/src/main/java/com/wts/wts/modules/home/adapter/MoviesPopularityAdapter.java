...
public class MoviesPopularityAdapter extends RecyclerView.Adapter<MoviesPopularityAdapter.MyViewHolder> {

    Context mContext;
    List<MoviesResults> al_movies;
    private MyViewHolder holder;

    public MoviesPopularityAdapter(Context mContext, List<MoviesResults> al_movies) {
