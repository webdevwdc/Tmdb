...
public class MoviesTopRatedAdapter extends RecyclerView.Adapter<MoviesTopRatedAdapter.MyViewHolder> {

    Context mContext;
    List<MoviesResults> al_movies;
    private MyViewHolder holder;

    public MoviesTopRatedAdapter(Context mContext, List<MoviesResults>  al_movies) {
